...
export class RealDataService {
    async getTreeData(search, forceRefresh = false, options) {
        try {
    ...
    async collectVueComponents(forceRefresh = false, blacklist, rootElementUid) {
    ...
    transformToTreeData(components, search) {
