 ...
 */
export function markElementWithUid(uid, element) {
 ...
 */
export function unmarkElementByUid(uid) {
 ...
 */
export function syncElementMarks() {
    try {
 ...
 */
export function notifyElementRegistryUpdate() {
    window.postMessage({
...
export const registerMetaElement = (meta) => {
    if (meta.rootEl && meta.rootEl.isConnected) {
        markElementWithUid(meta.uid, meta.rootEl);
    }
};
export const unregisterMetaElement = (meta) => {
