...
import { injectedScriptLoaded, setInjectedScriptLoaded, resetDetectionState } from './state';
 ...
 */
export function sendBroadcastToPanel(msg) {
    if (devtoolsPort) {
        try {
...
export function setupDevtoolsBridge() {
    try {
