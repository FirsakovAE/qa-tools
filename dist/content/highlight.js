 ...
 */
import { currentHighlightedElement, highlightOverlay, highlightRafId, setCurrentHighlightedElement, setHighlightOverlay, setHighlightRafId, getElementByUid } from './state';
/**
...
export function updateHighlightPosition() {
    if (!currentHighlightedElement || !highlightOverlay)
        return;
    if (highlightRafId)
        return;
 ...
 */
export function highlightByUid(uid) {
 ...
 */
export function removeHighlightEventListeners() {
    window.removeEventListener('scroll', updateHighlightPosition, { passive: true });
