 ...
 */
import { detectionCompleted, detectionStopped, featureFlags, messageListenerAdded, checkTimeout, setDetectionCompleted, setDetectionStopped, setFeatureFlags, setMessageListenerAdded, setCheckTimeout, } from './state';
 ...
 */
export function handleInjectedMessage(event) {
 ...
 */
export function addMessageListenerIfNeeded() {
