...
function setupSearchListener(port) {
    let lastQuery = '';
    ...
    port.onMessage.addListener((msg) => {
        ...
        if (!sel)
            return;
        const w = window;
        const find = (backwards) => w.find?.(searchQuery, false, backwards, true);
...
//# sourceMappingURL=useDevtoolsSearch.js.map