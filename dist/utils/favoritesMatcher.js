 ...
 */
export function parseComponentUid(componentUid) {
 ...
 */
export function generateStableFavoriteId(parsed) {
 ...
 */
export function getStableFavoriteId(componentUid) {
 ...
 */
export function matchFavoriteIds(id1, id2) {
    if (id1 === id2) {
        return true;
    }
 ...
 */
function buildStableIdFromMeta(fav) {
    if (!fav.name)
        return null;
 ...
 */
export function findMatchingFavorite(componentUid, favorites) {
 ...
 */
export function isInFavorites(componentUid, favorites) {
    return findMatchingFavorite(componentUid, favorites) !== undefined;
}
//# sourceMappingURL=favoritesMatcher.js.map