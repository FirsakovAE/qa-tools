...
Пока автообновление включено, инспектор **повторно запрашивает** актуальное состояние с страницы через выбранный интервал, **если вкладка не занята другой загрузкой** (очередные тики не наслаиваются друг на друга). Когда панель **скрыта** (свёрнута / неактивна в смысле видимости встраиваемого UI), таймер может **останавливаться**, чтобы не тратить ресурсы впустую; при **возврате** панели на экран цикл **возобновляется**.

**Вкладка Network** в список автообновляемых по этому же таймеру **не входит**: перехват и таблица запросов живут по своей логике потока событий страницы.
