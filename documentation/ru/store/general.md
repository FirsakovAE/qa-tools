...
После выбора строки справа открывается панель с вкладками **State** и **Getters** (если соответствующие секции непусты в сводке), редактором JSON (текст или дерево — по настройкам инспектора), кнопками **редактирования / сохранения** и возвратом к списку. Детали правок и ограничений — на страницах [State](/ru/store/state) и [Getters](/ru/store/getters).
