...
Краткая сводка «куда что ложится» по режимам — на странице [Установка → Где хранятся настройки](/ru/guide/install#storage).
...
- [Установка — хранение](/ru/guide/install#storage)
